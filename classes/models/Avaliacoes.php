...
class Avaliacoes extends DB {

	private $tabela = 'avaliacoes';
	private $id_estado;
	private $codigo_ibge;
	private $sigla;
	private $nome;
	...
	**/
	...
	public function retornar($id, $campo = 'id', $tabela = 'avaliacoes', $ordenadoPor = '', $order = '', $limit = '') {
		return parent::retornar($id, $campo, $tabela, $ordenadoPor, $order, $limit);
	}

	public function inserir($objeto, $tabela = 'avaliacoes') {
		return parent::inserir($objeto, $tabela);
	}

	public function editar($objeto, $campo = 'id', $tabela = 'avaliacoes') {
		return parent::editar($objeto, $campo, $tabela);
	}

	public function excluir($valor, $campo = 'id', $tabela = 'avaliacoes'){
