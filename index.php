...
<div id="divTitulo">
    	...
    	<div id="pagina" style="padding-top:54px; ">

  
 	
    <h2>Envolva-se</h2>
<p>envolvê-la na execução de políticas públicas realizadas por meio de convênios e transferências, facilitando o entendimento acerca de dados a elas relacionados e a fiscalização dessa execução de modo colaborativo entre Estado e sociedade.
</p>
<h2>Entenda</h2>
<p>envolvê-la na execução de políticas públicas realizadas por meio de convênios e transferências, facilitando o entendimento acerca de dados a elas relacionados e a fiscalização dessa execução de modo colaborativo entre Estado e sociedade.
</p>
